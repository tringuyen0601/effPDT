...
stateID  += 1
dense_csr_transition.write( str(transID) + "  :" + va.Input[1] + "-" + va.passthrough +", 512-512," +  str(stateID-1) + "  | ")
dense_csr_transition.write( va.Output[3] +  "-"+ va.Input[1] + " ," + va.Stack[0] + "-0, " + str(stateID)  + "\n")  
transID +=  1
...
stateID  += 1
dense_csr_transition.write( str(transID) + "  :" + va.Input[1] + "-" + va.passthrough + ", 512-512," +  str(stateID-1) + "  | ")
dense_csr_transition.write( va.Output[3] +  "-"+ va.Input[1] + " ," + va.Stack[2] + "-" + va.Input[1] +", " + str(stateID)  + "\n")  
transID +=  1
...
stateID  += 1
dense_csr_transition.write( str(transID) + "  :" + va.Input[1] + "-" + va.passthrough + ", 512-512," +  str(stateID-1) + "  | ")
dense_csr_transition.write(  va.Output[3]+ "-"+va.Input[1]  + "," + va.Stack[4] + "-"+ va.Input[1]+   ", " + str(stateID)  + "\n")  
transID +=  1
...
stateID  += 1
dense_csr_transition.write( str(transID) + "  : 512-512, 512-512," +  str(stateID-1) + "  | ")  
dense_csr_transition.write(  va.Output[0]+ "-0 ," + va.Stack[5] + "-0 , " + str(stateID)  + "\n")  
transID +=  1
...
#dense_csr_transition.write( str(transID) + "  : " + va.Input[0] +"-256, " + va.Stack[3] +"-" + va.passthrough +"," +  str(stateID-1) + "  | ")
dense_csr_transition.write( str(transID) + "  : " + va.Input[0] +"-256, 512-512," +  str(stateID-1) + "  | ")
dense_csr_transition.write( "512-512, " + va.Stack[3] + "-" + va.Input[0] +", " + str(stateID)  + "\n")  
transID +=  1
...
dense_csr_transition.write( str(transID) + "  : 512-512, 512-512," +  str(stateID-1) + "  | ")
#dense_csr_transition.write(  va.Output[0]+"-"+ va.Stack[0] + ", 512-512  , " + str(stateID)  + "\n")  
...
# write column cooridinate
dense_csr_transition.write( str(transID) + "  : 512-512, 512-512," +  str(stateID-1) + "  | ")  
dense_csr_transition.write(  va.Output[1]+"-"+ va.Stack[1] + ", 512-512  , " + str(stateID)  + "\n")  
transID +=  1
dense_csr_state.write(str(stateID)  + ", EPSILON, 0,0,0,0,0\n")
stateID  += 1
...
# write value 
dense_csr_transition.write( str(transID) + "  : 512-512, 512-512," +  str(stateID-1) + "  | ")  
dense_csr_transition.write(  va.Output[2]+"-"+ va.Stack[3] + ", 512-512  , " + str(stateID)  + "\n")  
transID +=  1
...
# Reset Stack 3 
dense_csr_transition.write( str(transID) + "  : 512-512, " + va.Stack[3] + "-"+ va.passthrough+"," +  str(stateID-1) + "  | ")  
dense_csr_transition.write(  "512-512, 512-512  , " + str(stateID)  + "\n")  
transID +=  1

#value is 0, skip output
dense_csr_transition.write( str(transID) + "  :" +va.Input[0]+"-0, 512-512," +  str(outputState) + "  | ")
dense_csr_transition.write( "512-512, 512-512  , " + str(stateID)  + "\n")  
transID +=  1
...
dense_csr_transition.write( "512-512, "+ va.Stack[1]+"-" + va.anyPush+ " , " + str(outputState)  + "\n")  
transID +=  1


# i = max column
dense_csr_transition.write( str(transID) + "  : 512-512, "+ va.Stack[1]+"-" + va.Stack[2]+ "," +  str(stateID-1) + "  | ")
dense_csr_transition.write( "512-512, "+ va.Stack[1]+"-" + va.anyPush+ " , " + str(stateID)  + "\n")  
transID +=  1
# reset column j-terator, output csr ptr
dense_csr_state.write(str(stateID)  + ", EPSILON, 0,0,0,0,0\n")
stateID  += 1
dense_csr_transition.write( str(transID) + "  : 512-512, "+ va.Stack[1]+"-"+ va.passthrough+"," +  str(stateID-1) + "  | ")
dense_csr_transition.write( va.Output[0] + "-" + va.Stack[5]+", "+ va.Stack[1] + "-0  , " + str(stateID)  + "\n")  
#dense_csr_transition.write( "512-512, "+ va.Stack[1] + "-0  , " + str(stateID)  + "\n")  
transID +=  1
