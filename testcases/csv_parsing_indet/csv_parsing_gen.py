...
csv_transition.write( str(transID) + "  : 512-512, "+ va.Stack[1] +"-" + str(output_col)+", " +str(initialState)+" | ")
...
csv_transition.write( "512-512," +va.Stack[0] +"-" + va.Input[0]+", " + str(stateID-1)  + "\n")
transID +=  1
...
csv_state.write( str(stateID) + ", EPSILON, 0,0,0,0,0\n")
stateID +=1
# read until finding conditional column
csv_transition.write( str(transID) + "  : 512-512, "+ va.Stack[1] +"-" + str(256 + cond_col)+", " +str(condState)+" | ")
csv_transition.write( "512-512 , 512-512, " + str(stateID)  + "\n")
transID +=  1
csv_state.write( str(stateID) + ", EPSILON, 0,0,0,0,0\n")
stateID +=1
...
csv_transition.write( str(transID) + "  : 512-512, 512-512, " +str(stateID-1)+" | ")
csv_transition.write( "512-512 , 512-512, " + str(condState)  + "\n")
transID +=  1


#found conditional state, compare
csv_transition.write( str(transID) + "  : 512-512, "+ va.Stack[1] +"-" + str(cond_col)+", " +str(condState)+" | ")
csv_transition.write( "512-512 , 512-512, " + str(stateID)  + "\n")
transID +=  1
csv_state.write( str(stateID) + ", EPSILON, 0,0,0,0,0\n")
stateID +=1
...
csv_transition.write( va.Output[0]+"-" + va.Stack[0]+", "+ va.Stack[0]+"-" +va.anyPush +", " + str(stateID)  + "\n")
transID +=  1
#1.1-no
# not match, pass
csv_transition.write( str(transID) + "  :" + va.Input[0] + "-" + str(256+ condition) +", 512-512," +  str(stateID-1) + "  | ")
csv_transition.write( "512-512, "+ va.Stack[0]+"-" +va.anyPush +", " + str(stateID)  + "\n")
transID +=  1
...
###########################
# not output column, read until find output column
#1-no
csv_transition.write( str(transID) + "  : 512-512, "+ va.Stack[1] +"-" + str(256+output_col)+", " +str(initialState)+" | ")
csv_transition.write( "512-512 , 512-512, " + str(stateID)  + "\n")
transID +=  1
